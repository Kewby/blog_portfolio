<?php
    ...
    function displayUserPosts(){
        ...
        $sql = "SELECT * FROM posts INNER JOIN categories ON categories.category_id = posts.category_id WHERE user_id = '$user_id'";
    ...
    function addPost($user_id){
        ...
        $sql = "INSERT INTO posts (post_title, date_posted, category_id, post_message, user_id) VALUES ('$title','$date_posted','$category_id','$message', $user_id)";
    ...
    function displayUpdatePost(){
        ...
        if($result->num_rows == 1){
            ...
            <form action='' method='post'>
                <div class='form-row'>
                    <div class='form-group col-md-10 mx-auto'>
                        <input type='text' name='new_title' id='' class='form-control lighto custom-form' value='".$title."'>
                    </div>
                </div>
                <div class='form-row'>
                    <div class='form-group col-md-10 mx-auto'>
                        <input type='date' name='new_date_posted' id='' class='form-control lighto custom-form'
                        value='".$date_posted."'>
                    </div>
                </div>
                <div class='form-row'>
                    <div class='form-group col-md-10 mx-auto'>
                        <select name='new_category' id='' class='form-control lighto custom-form'>
            ...
            echo"
                ...
                <div class='form-row'>
                    <div class='form-group col-md-10 mx-auto'>
                        <textarea name='new_message' id='' class='form-control lighto custom-form' rows='7'>".$message."</textarea>
                    </div>
                </div>
                <div class='form-row'>
                    <div class='form-group col-md-10 mx-auto'>
    ...
    function updatePost($post_id){
        ...
        // echo $new_title,$new_date_posted,$new_category, $new_message, $post_id;
